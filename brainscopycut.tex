...
\abstract{
\newtext{We present a case study which connects psycholinguistics with the field of cultural evolution, in order to test for the existence of cultural attractors in the evolution of quotations online.
Such attractors have been suggested as a useful tool for the study of cultural evolution and its reciprocal influences with cognition, but their existence has been hard to test.
Our study focuses on how quotations are transformed when they are copied from blog to blog or media website:
...
Our results support the hypothesis that cultural attractors can arise from the combination of individual cognitive biases in interpretation and production of representations.}
}
