...
%Broadly speaking, this type of research program is bound to
 investigate phenomena pertaining to both cognitive science and social science, %and aims to understand the processing, transmission, and evolution of information 
...
Despite some recent modeling attempts (for instance \citet{Claidiere07}), the development of quantitative measurements focused on the key notion of cultural attractor has remained a relatively hard task and, to our knowledge, this hypothesis has not yet been \TB{extensively} empirically analyzed.\marginnote{\seb{Deux adverbes. Pas encore trouvé d'autre formulation.}}
