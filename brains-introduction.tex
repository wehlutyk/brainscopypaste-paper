...
For one, models involving evolution and representations to study the notion of ``cultural attractor'' have appeared only a few years ago \citep{Claidiere07,claidiere2014darwinian}\marginnote{S: il y a beaucoup de meta-études philosophiques où ils reprennent des études empiriques, mais toujours peu de modèles. Peut-être que tu veux vérifer les deux que j'ai réjouté? il y a aussi éventuellement \citet{claidiere2009imitation} avec un peu de modèle, \citet{maccallum2012evolution} plus empirique, et \citet{claidiere2012effect} qui le commente}.
...
Less classical linguistic variables, based on the study of semantic network properties, have recently started to be used, in the context of connectionism and its normative processual models (see for instance \citet{collins1975spreading} for an example of such models).
