...
(3) introduce the question of cultural attractors,
(4) present big data literature which can bring measurement tools,
(5) to be studied through quotes on the web: it's the proposal of an online approach, we'll be describing and cross-checking with existing literature (vs. predicting, since there are too many possible things to predict)
}
