...
We initially aimed to connect the field of cultural evolution with psycholinguistics by asking if cultural attractors appear in a corpus of online news-related quotes which are gradually transformed by low-level biases.
...
Exploring how similar loop interactions happen in real-life data could indeed be the next step in understanding the \tb{co}evolution of both cultural content and the ways in which it is transformed.
In our particular case, such insight could shed some light on how the feature attractors \tb{examined} in this paper actually emerge, and help assess their potential \tb{role on this coevolution}.
