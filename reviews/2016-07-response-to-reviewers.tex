...
\answer{
Point to:
- the added POS analysis
- the short discussion of distances travelled upon substitution
}
...
\answer{Point to the regression model we introduced.}
...
\answer{We hope it is now clarified.}
...
\answer{Yes, because of the similar curve shapes they had.
...
\answer{Thank you for these very useful pointers, we accordingly devoted a significant portion of the literature review to the issue of recall (see the ``Related work'' section).}
