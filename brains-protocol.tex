...
In practice, quotations appeared indeed to be a perfect candidate for designing a first \emph{in vivo} measure of low-level cognitive bias in a reformulation task. % as public representations.
...
This measure focuses on the selection of start words involved in substitutions, measuring the effect of features at the moment preceding the substitution when it is not yet known which word in the quotation will be substituted.
