...
\section{Observing the substitution process}
...
To do so we first propose a substitution detection model. 

The utterance data we use presents a challenge: each set of quotations bears no explicit information either about the authoritative original quotation, or about the source quotation(s) each author inspired himself from when creating a new post and reproducing (possibly altering) those sources.
