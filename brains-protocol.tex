...
\tb{However, the substituted and subtituting words are rarely direct synonyms:} only a third of all substitutions travel less than 3 hops on the hyponym-hypernym network defined by WordNet (direct synonyms count as 0~hops on this network), meaning that at least two thirds involve non-synonyms.\footnote{
...
\begin{figure}[h]
    ...
    source feature values and feature variations were normalized to $[0; 1]$ to ensure the coefficients are comparable.
