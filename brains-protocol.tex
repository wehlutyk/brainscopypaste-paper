...
\rk{Adapt this last paragraph once the model is really chosen (see below)}
...
\rk{Choose which figure to show (see garbage at the end of file)}

\rk{Once chosen, comment results and transition to micro process}
