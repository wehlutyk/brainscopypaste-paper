...
\todo{Relate to missed literature}
...
\newtext{More awkward words along relevant features (less frequent, learned later, or with made of more letters), both globally and with respect to the sentence they appear in, are substituted more often than more common words.
And across all features, words are brought generally closer to the sentence median than what a random process would do.}