...
\tbn{The results and graphics for the 16 additional models involved are available in the code repository for this paper: \url{https://github.com/wehlutyk/brainscopypaste}.}}
}
...
\begin{figure}[h]
    ...
    categories are simplified from the TreeTagger tag set: \emph{J} means adjective, \emph{N}~noun, \emph{R}~adverb, \emph{V}~verb, and \tb{\emph{S} means \emph{Stopword-like}} %together all the categories \tb{essentially made of stopwords} 
