...
\begin{figure*}[!th]
	...
	%%%%
    % Cam: J'ai viré la phrase ci-dessus car redondante et même contradictoire avec le texte.
    %%%%
    ...
    Without the rather unsignificant cells (11 words or less), the heatmap shows no specific trend in a direction or another.}
