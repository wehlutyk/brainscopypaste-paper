...
Since $\phi(\warrival_0)$ is in fact a constant in the above averaging (by definition $\warrival_0$ does not depend on $\wstart$) and $\phi(\wstart)=f$, 
the baseline variation under $\mathcal{H}_0$ may be rewritten:
