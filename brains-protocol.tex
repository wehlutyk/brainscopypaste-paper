...
\newtext{For a given group of words $g$, susceptibility is computed as the ratio of the number of times $s_g$ words of that group are substituted to the number of times $s_g^0$ words of that group would be substituted if substitutions fell randomly on substitutable words, that is:}\footnote{
...
\begin{figure}[h]
    ...
    \todo{Split into 2 subfigures; fix labels; add H0 dashed line.}}
