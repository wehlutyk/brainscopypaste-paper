...
\begin{figure}[h]
    ...
    categories are simplified from the TreeTagger tag set: \tb{\emph{C} means \emph{Closed class-like}} (see main text for details), \emph{J} means adjective, \emph{N}~noun, \emph{R}~adverb, and \emph{V} means verb.
