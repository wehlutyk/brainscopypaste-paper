...
\begin{itemize}
    \item \rk{Add word frequency as a feature, and maybe link it to Kolmogorov's 5/3 law in turbulences}
...
\rk{Roll back to directed FA, and explain that it's a link between in-vivo spontaneous substitution and in-vitro forced substitution.
We could even add a more precise analysis using FA data directly (instead of features on the FA network), or keep that for the processual model.}
...
\begin{itemize}
    ...
    \rk{Rephrase once we rolled back FA to directed}
...
\begin{figure}[!th]
    \includegraphics[width=\linewidth]{images/feature-cards/correlation_plot-full.png}
