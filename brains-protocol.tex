...
\begin{figure}[h]
    ...
    categories are simplified from the TreeTagger tag set: \emph{J} means adjective, \emph{N}~noun, \emph{R}~adverb, \emph{V}~verb, and \tb{\emph{C} means \emph{Closed class-like}}
...
\newtext{The \emph{Closed class-like} category gathers all the POS groups \tb{representing closed class words (coordinating conjunctions, prepositions, subordinating conjunctions, modals and possessive endings).
