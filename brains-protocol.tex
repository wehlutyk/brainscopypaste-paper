...
or accurate reproductions of the previous occurrences of $q_b$? \cam{là je distinguerais 3a [top] de 3b [middle \& bottom]} (options shown in Figure~\ref{fig:substitution-detection-example1})?
